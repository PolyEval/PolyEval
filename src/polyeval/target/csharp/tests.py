...
from polyeval.target.csharp.value import CSharpTargetValue
...
class CSharpTargetTests(BaseTargetTests):
    def __init__(self):
        self.naming = CSharpTargetNaming()
        self.type = CSharpTargetType()
        self.value = CSharpTargetValue()
...
"""
    ...
    def gen_function_test(
        ...
        test_code = f"""\
static string {test_item_func_name}() {{
