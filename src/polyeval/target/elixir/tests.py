...
from polyeval.target.elixir.value import ElixirTargetValue
...
class ElixirTargetTests(BaseTargetTests):
    def __init__(self):
        self.naming = ElixirTargetNaming()
        self.type = ElixirTargetType()
        self.value = ElixirTargetValue()
