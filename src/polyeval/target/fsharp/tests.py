...
from polyeval.target.fsharp.type import FSharpTargetType
from polyeval.target.fsharp.value import FSharpTargetValue
from polyeval.target.fsharp.naming import FSharpTargetNaming
from polyeval.target.fsharp.value_stringify import FSharpTargetValueStringify

import json


class FSharpTargetTests(BaseTargetTests):
    def __init__(self):
        self.naming = FSharpTargetNaming()
        self.type = FSharpTargetType()
        self.value = FSharpTargetValue()
        self.stringify = FSharpTargetValueStringify()
        pass
