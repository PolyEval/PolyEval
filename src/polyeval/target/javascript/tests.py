...
from polyeval.target.javascript.value import JavaScriptTargetValue
...
class JavaScriptTargetTests(BaseTargetTests):
    def __init__(self):
        self.naming = JavaScriptTargetNaming()
        self.type = JavaScriptTargetType()
        self.value = JavaScriptTargetValue()
