...
from polyeval.target.kotlin.value import KotlinTargetValue
...
class KotlinTargetTests(BaseTargetTests):
    def __init__(self):
        self.naming = KotlinTargetNaming()
        self.type = KotlinTargetType()
        self.value = KotlinTargetValue()
...
"""
    ...
    def gen_function_test(
        ...
        test_code = f"""\
fun {test_item_func_name}(): String {{
