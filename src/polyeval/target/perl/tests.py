...
from polyeval.target.perl.value import PerlTargetValue
...
class PerlTargetTests(BaseTargetTests):
    def __init__(self):
        self.naming = PerlTargetNaming()
        self.type = PerlTargetType()
        self.value = PerlTargetValue()
