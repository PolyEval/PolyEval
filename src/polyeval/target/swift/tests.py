...
from polyeval.target.swift.value import SwiftTargetValue
...
class SwiftTargetTests(BaseTargetTests):
    def __init__(self):
        self.naming = SwiftTargetNaming()
        self.type = SwiftTargetType()
        self.value = SwiftTargetValue()
...
"""
    ...
    def gen_function_test(
        ...
        test_code = f"""\
func {test_item_func_name}() -> String {{
